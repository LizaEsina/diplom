    ...
    <form @submit.prevent="createLesson" class="lesson-form">
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <select v-model="lesson.category" id="category" required class="styled-select">
        ...
        <div class="form-group">
          ...
          <select v-model="lesson.difficulty" id="difficulty" required class="styled-select">
        ...
        <div class="form-group">
          ...
          <input v-model.number="lesson.points" id="points" type="number" min="1" required class="styled-input" />
        </div>
      </div>

      <div class="form-group">
        <label for="theory_content">Теория</label>
        <textarea 
          v-model="lesson.theory_content" 
          id="theory_content" 
          rows="8" 
          required 
      ...
      <div class="code-editors">
        <div class="code-group">
          ...
          <div class="code-container">
            <textarea 
              v-model="lesson.vulnerable_code" 
              id="vulnerable_code" 
              rows="10" 
              required 
              class="code-textarea"
    ...
    methods: {
      ...
      async createLesson() {
        ...
        try {
          ...
          const response = await this.$axios.post('http://localhost:9000/api/admin/lessons.php', this.lesson, {
            headers: {
          ...
          this.successMessage = 'Урок успешно создан! ID: ' + response.data.id
          this.resetForm()
        } catch (error) {
          this.errorMessage = error.response?.data?.error || 'Ошибка при создании урока'
